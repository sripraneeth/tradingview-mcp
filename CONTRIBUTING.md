...
### 🐛 Report Bugs
- Found a bug? [Open an issue](https://github.com/sripraneeth/tradingview-mcp/issues/new)
- Include reproduction steps, expected vs actual behavior
- Provide system info (OS, Python version, UV version)

### 💡 Suggest Features
- Have an idea? [Create a feature request](https://github.com/sripraneeth/tradingview-mcp/issues/new)
